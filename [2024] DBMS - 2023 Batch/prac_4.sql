...
create table sales_order_details(Order_no varchar(6), foreign key(Order_no) references sales_order(Order_no), Product_no varchar(6) , foreign key(Product_no) references product_master(Product_no) ,Qty_ordered numeric(8) ,Qty_disp numeric(8) ,Product_rate numeric(10,2));
